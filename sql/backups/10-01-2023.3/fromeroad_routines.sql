...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `updatetopten` ON SCHEDULE EVERY 5 MINUTE STARTS '2023-01-10 10:38:18' ON COMPLETION NOT PRESERVE DISABLE DO call sp_updatetopten */ ;;
...
-- Dump completed on 2023-01-10 22:08:13
