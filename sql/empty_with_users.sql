...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `deletecodes` ON SCHEDULE EVERY 1 HOUR STARTS '2023-04-19 00:00:00' ON COMPLETION PRESERVE ENABLE DO call sp_resetcodes */ ;;
