...
const AboutDiv: React.FC<Props> = (props) => {
  return (
    <div className='aboutDiv'>
      ...
      <p className={props.darkMode ? 'aboutTextDarkMode' : 'aboutText'}>Contributors may be added in future (depending on reception). For now you can access the repo once logged in and verified :)</p>
    </div>
  );
}
